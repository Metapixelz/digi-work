...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by DigiWork.",
        description: "Your browser is too old to run DigiWork. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave DigiWork and use a different browser",
        updateBrowser: "Update Browser",
        leave: "Leave",
    },
    pwaInstall: {
        title: "Install DigiWork",
        description:
            "Install the app for a better experience: quick access, load on startup and an app-like experience.",
        descriptionIos: "Add DigiWork to your Home Screen for a better experience and quick access.",
        feature1Title: "Quick access",
        feature1Description: "Launch DigiWork from your Start menu, Dock, or desktop.",
        feature2Title: "Dedicated app window",
        feature2Description:
            "Keep DigiWork separate from your browser tabs and find DigiWork at a glance in your taskbar.",
        feature3Title: "Start with your computer",
        feature3Description: "Launch DigiWork when your device starts.",
