...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Ihr Browser ({browserName}) wird von DigiWork nicht mehr unterstützt.",
        description:
            "Ihr Browser ist zu alt, um DigiWork auszuführen. Bitte aktualisieren Sie ihn auf die neueste Version, um fortzufahren.",
        whatToDo: "Was können Sie tun?",
        option1: "{browserName} auf die neueste Version aktualisieren",
        option2: "DigiWork verlassen und einen anderen Browser verwenden",
        updateBrowser: "Browser aktualisieren",
        leave: "Verlassen",
    },
    pwaInstall: {
        title: "DigiWork installieren",
        description:
            "Installieren Sie die App für ein besseres Erlebnis: schneller Zugriff, automatischer Start und ein app-ähnliches Erlebnis.",
        descriptionIos:
            "Fügen Sie DigiWork für ein besseres Erlebnis und schnellen Zugriff zu Ihrem Home-Bildschirm hinzu.",
        feature1Title: "Schneller Zugriff",
        feature1Description: "Starten Sie DigiWork über Ihr Startmenü, Dock oder Ihren Desktop.",
        feature2Title: "Eigenes App-Fenster",
        feature2Description:
            "Halten Sie DigiWork getrennt von Ihren Browser-Tabs und finden Sie DigiWork auf einen Blick in Ihrer Taskleiste.",
        feature3Title: "Mit dem Computer starten",
        feature3Description: "Starten Sie DigiWork, wenn Ihr Gerät hochfährt.",
        ...
        install: "DigiWork-App installieren",
